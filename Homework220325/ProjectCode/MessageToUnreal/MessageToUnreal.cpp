...
int main()
{
...

	{
		...
		{
			std::string OpenPath = FileDir.PathToPlusFileName("ServerToClient.h");
		...
		{
			std::string OpenPath = FileDir.PathToPlusFileName("ClientToServer.h");
		...
		{
			std::string OpenPath = FileDir.PathToPlusFileName("ServerAndClient.h");
...

		{
			...
			std::string OpenPath = FileDir.PathToPlusFileName("MessageIdEnum.h");
...

		{
			...
			std::string OpenPath = FileDir.PathToPlusFileName("ContentsEnums.h");
...

		{
			...
			std::string OpenPath = FileDir.PathToPlusFileName("MessageConverter.cpp");
